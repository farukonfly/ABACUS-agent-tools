...
def generate_work_path(create: bool = True, base_dir: Optional[str] = None) -> str:
    """
    ...
    If base_dir is provided, the working directory is created under base_dir.
    ...
    if base_dir:
        work_path = os.path.join(base_dir, work_path)
    if create:
        os.makedirs(work_path, exist_ok=True)
